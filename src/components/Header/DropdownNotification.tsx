...
const notificationList = [
  {
    ...
    title: "پیتر به تیم پیوست!",
    subTitle: "به او تبریک بگویید",
  },
  {
    image: "/images/user/user-02.png",
    title: "پیام جدید دریافت شد",
    subTitle: "دِیوید برای شما پیام جدیدی فرستاده است",
  },
  {
    image: "/images/user/user-26.png",
    title: "پرداخت جدید دریافت شد",
    subTitle: "درآمد خود را بررسی کنید",
  },
  {
    image: "/images/user/user-28.png",
    title: "جولی وظایفش را تکمیل کرد",
    subTitle: "وظایف جدیدی به او اختصاص دهید",
  },
  {
    image: "/images/user/user-27.png",
    title: "رومن به تیم پیوست!",
    subTitle: "به او تبریک بگویید",
  },
];
  ...
  return (
    ...
    >
      <li>
        ...
        {dropdownOpen && (
          <div
            className={`absolute -right-27 mt-7.5 flex h-[550px] w-75 flex-col rounded-xl border-[0.5px] border-stroke bg-white px-5.5 pb-5.5 pt-5 shadow-default dark:border-dark-3 dark:bg-gray-dark sm:-right-36 sm:w-[364px]`}
          >
