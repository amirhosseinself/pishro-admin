        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-[720px]">
              ...
              <p className="mt-4">
                برنامه نویس فرانت‌اند با تجربه در ساخت برنامه‌های وب تعاملی و
                پاسخگو با استفاده از فناوری‌های مدرن مانند React، Next.js و
                Tailwind CSS. علاقه‌مند به ایجاد رابط‌های کاربری زیبا و بهینه که
                تجربه کاربری استثنایی را ارائه می‌دهند.
              </p>
            </div>
